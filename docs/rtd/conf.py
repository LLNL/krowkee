...
project = "krowkee"
copyright = "2025, krowkee Developers"
author = "krowkee Developers"
...
breathe_projects = {"krowkee": "https://github.com/LLNL/krowkee"}
...
def run_cmake_build(build_dir):
    ...
    try:
        ...
        subprocess.run(
            ["cmake", "../../../", "-DKROWKEE_RTD_ONLY=ON"], check=True
        )
...
if read_the_docs_build:
    ...
    breathe_projects = {"krowkee": build_dir + "/docs/xml/"}
